...
import 'package:goair/ui/pages/success_checkout_page.dart';
import 'package:goair/ui/widgets/booking_details_item.dart';
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            BookingDetailsItem(
              title: 'Traveler',
              valueText: '${transaction.amoutOfTraveler} person',
